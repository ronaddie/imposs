...
\author{Ron~Addie,~\IEEEmembership{Member,~IEEE,}
...
I am sure you (David) are familiar with the long historical discussion of the difficulty of inductive reasoning. I seem to recall that you brought my attention to it by explaining Karl Popper's "solution", which is that the scientific method is really about trying to find evidence against a hypothesis, and when this can't be found, despite our best efforts, this is regarded as strong evidence for the hypothesis. The problem of inductive reasoning was probably first investigated, with no satisfactory resolution, by David Hume. Popper's resolution was, and remains, quite influential.

Apparently this debate has not ceased since Popper's contribution, and from some points of view, there is still no universally accepted resolution.
