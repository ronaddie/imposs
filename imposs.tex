...
[Consider the objective that only certificates that are genuine can be validated.
This example describes the context, the problem, and the objective.]

\subsection{Access to Client Data}
[Consider the objective that only clients can alter their own personal data.
This example describes the context, the problem, and the objective.]
